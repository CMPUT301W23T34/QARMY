...
public class Database {
    ...
    /**
     ...
     @param qrCode a string representing the QR code hash to search for.
     ...
     @throws QRCodeNotFoundException if no QR codes matching the provided hash are found.
     @throws QRCodeDatabaseException if there is an error accessing the database.
     */
    public void getCodesByName(QRCode qrCode, QueryListener<QRCode> listener) {
